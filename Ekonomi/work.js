...
//== BEERCODE (https://discord.gg/ew3dpTu4Z5) BEERCODE ==\\
  if (times !== null && day - (Date.now() - times) > 0) {
    ...
    message.channel.send(new Discord.MessageEmbed()
                        ...
                        .setDescription(`<a:875051721288732762:897506485251227729> To work ${time.minutes ? time.minutes + ' minute,' : ''} ${time.seconds ? time.seconds + ' you have to wait seconds!' : 're-enter the command!'}`))
  return
  }//== BEERCODE (https://discord.gg/ew3dpTu4Z5) BEERCODE ==\\
...
let moneys = rastgeleMiktar(400,100);
      message.channel.send(new Discord.MessageEmbed()
                   .setAuthor(message.author.tag, message.author.avatarURL({dynamic: true}))
                   .setColor("YELLOW")
                   .setDescription(`${work} you worked and ${moneys} <a:875051634386935880:897506842748530729> you won!`))
//== BEERCODE (https://discord.gg/ew3dpTu4Z5) BEERCODE ==\\
